...
TEST_CASE("Test complex Variable First-order equation"){
    ...
    CHECK(solve(x==1)==1+0i);
    CHECK(solve(2*x-x == 10)==10+0i);
    CHECK(solve(x-4 == 10)==14+0i);
    CHECK(solve(x+4 == 10)==6+0i);
    CHECK(solve(2*x-4 == 10)==7+0i);
    CHECK(solve(2*x-4.0 == 10.0)==7+0i);
    CHECK(solve(2-4*x == 10)==-2+0i);
    CHECK(solve(2.0-4.0*x == 10.0)==-2+0i);
    CHECK(solve(2*x-4*x == 10)==-5+0i);
    CHECK(solve(2*x-4.0*x == 10.0)==-5+0i);
    CHECK(solve(2*x+4 == 10)==3+0i);
    CHECK(solve(2.0*x+4 == 10.0)==3+0i);
    CHECK(solve(2+4*x == 10)==2+0i);
    CHECK(solve(2.0+4*x == 10.0)==2+0i);
    CHECK(solve(2*x+2*x == 10)==4.5+0i);
    CHECK(solve(2.0*x+2.0*x == 10.0)==4.5+0i);

    CHECK(solve(x/1 == 10)==10+0i);
    CHECK(solve(x/2 == 10)==20+0i);
    CHECK(solve(2+4*x/2 == 10)==4+0i);
    CHECK(solve(2.0+4*x/2.0 == 10.0)==4+0i);
    CHECK(solve(2*x/2-3*x == 10)==-5+0i);

    CHECK(solve(2-4*x+4 == 10)==-1+0i);
    CHECK(solve(2-4*x+4-x == 16)==-5+0i);
    CHECK(solve(2*x-4+4*x == 10)==1+0i);
    CHECK(solve(2*x-4-4*x == 10)==-7+0i);
    CHECK(solve(2*x-4*x+4 == 10)==-3+0i);
}
...
TEST_CASE("Test complex Variable First-order equation from two sides"){
    ...
    CHECK(solve(2*x+4 == 10-x)==2+0i);
    CHECK(solve(2*x+4.0 == 10.0-x)==2+0i);
    CHECK(solve(2*x+4 == 10+x)==6+0i);
    CHECK(solve(2*x+4.0 == 10.0+x)==6+0i);
    CHECK(solve(2*x+40 == 10*x)==5+0i);
    CHECK(solve(2*x+40.0 == 10.0*x)==5+0i);
    CHECK(solve(2*x+4 == x/1)==-4+0i);
    CHECK(solve(2*x+4.0 == x/1.0)==-4+0i);
    CHECK(solve(2-4*x == 10-2*x)==-4+0i);
    CHECK(solve(2.0-4.0*x == x+10.0)==-1.6+0i);
    CHECK(solve(2*x-4*x == x-10-2)==4+0i);
    CHECK(solve(2*x-4*x == 10-x)==-10+0i);
    CHECK(solve(2*x+4.0*x == x+10.0)==2+0i);
    CHECK(solve(2*x+4 == 10+x+2)==8+0i);
    CHECK(solve(2*x+4 == x+10-x-2)==2+0i);
    CHECK(solve(2*x+4 == 10*x-4)==1+0i);
    CHECK(solve(2+4*x+1 == 10+1)==2+0i);
    CHECK(solve(3.0+4*x+1-1 == 10.0+x-1)==4+0i);
    CHECK(solve(4+2*x+2*x == 10-2*x)==1+0i);
    CHECK(solve(2.0*x+2.0*x-1 == 10.0-1+2*x)==5+0i);
    
    CHECK(solve(2+4*x/2 == 2+10*x+8)==-1+0i);
    CHECK(solve(2*x + 4.0 == 20 + 6.0*x/2 - 2*x)==16+0i);
    CHECK(solve(2.0+4*x/2.0 == 10.0-x/2)==3.2+0i);
    CHECK(solve(2*x/2-3*x == x-6*x/3+20)==-20+0i);
    CHECK(solve(2*x*2-3*x == x-6*x/3+20)==10+0i);
    CHECK(solve(2*x*2/2 == x+6*x/3*2)==0+0i);

    CHECK(solve(x+5i == 2*x+3i)==0+2i);
}
...
TEST_CASE("Test Complex Variable Second-order equation"){
    ...
    CHECK((solve((x^2) == 16)==0+4i || solve((x^2) == 16)==0-4i));
    CHECK((solve((x^2) + 2*x + 4.0 == 20 + 6.0*x/2 - x)==4+0i || solve((x^2) + 2*x + 4.0 == 20 + 6.0*x/2 - x)==-4+0i));
    CHECK(solve((x^2) + 2*x + 4.0 == (x^2) + 20 + 6.0*x/2 )==-16+0i );
    CHECK((solve((x^2) + 4.0 == 20)==4+0i || solve((x^2) + 4.0 == 20)==-4+0i));
    CHECK((solve(2*x + (x^2) + 4.0 == 20 + 6.0*x/2 - x)==4+0i || solve( 2*x + (x^2) + 4.0 == 20 + 6.0*x/2 - x)==-4+0i));
}
